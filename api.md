...
- <code><a href="./src/resources/fleetify/routes/routes.ts">Response</a></code>
...
- <code><a href="./src/resources/lookup.ts">LookupRetrieveByIDResponse</a></code>

Methods:

- <code title="get /lookup">client.lookup.<a href="./src/resources/lookup.ts">retrieveByID</a>({ ...params }) -> LookupRetrieveByIDResponse</code>
