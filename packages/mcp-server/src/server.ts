...
import { ClientOptions } from 'nextbillion-sdk';
...
export { ClientOptions } from 'nextbillion-sdk';
export { endpoints } from './tools';

// Create server instance
export const server = new McpServer(
  {
    name: 'nextbillion_sdk_api',
...
export function init(params: {
  ...
  const client = params.client || new NextbillionSDK({ defaultHeaders: { 'X-Stainless-MCP': 'true' } });
