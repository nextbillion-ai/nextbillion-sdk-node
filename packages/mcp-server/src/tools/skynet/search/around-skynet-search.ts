...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      radius: {
        type: 'number',
        description: 'Radius, in meters, of the circular area to be searched.',
      },
      filter: {
        type: 'string',
        description:
...
export const handler = async (client: NextbillionSDK, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.skynet.search.around(body));
};
