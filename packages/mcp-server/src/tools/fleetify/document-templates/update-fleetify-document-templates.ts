...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      name: {
        type: 'string',
        description: 'Specify the document template name to be updated.',
      },
      jq_filter: {
        type: 'string',
        title: 'jq Filter',
      ...
      document_template_content_request: {
        ...
        properties: {
          ...
          name: {
            type: 'string',
            description:
              "Specify the name of the document field. A field's`name` can be used for internal references to the document field.",
          },
          required: {
            type: 'boolean',
