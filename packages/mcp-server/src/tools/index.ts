...
import list_skynet_asset from './skynet/asset/list-skynet-asset';
import delete_skynet_asset from './skynet/asset/delete-skynet-asset';
import bind_skynet_asset from './skynet/asset/bind-skynet-asset';
...
import list_asset_skynet_event from './skynet/asset/event/list-asset-skynet-event';
import list_asset_skynet_location from './skynet/asset/location/list-asset-skynet-location';
import get_last_asset_skynet_location from './skynet/asset/location/get-last-asset-skynet-location';
...
import list_skynet_monitor from './skynet/monitor/list-skynet-monitor';
...
import get_summary_skynet_trip from './skynet/trip/get-summary-skynet-trip';
import start_skynet_trip from './skynet/trip/start-skynet-trip';
import create_skynet_namespaced_apikeys from './skynet/namespaced-apikeys/create-skynet-namespaced-apikeys';
import delete_skynet_namespaced_apikeys from './skynet/namespaced-apikeys/delete-skynet-namespaced-apikeys';
import retrieve_skynet_config from './skynet/config/retrieve-skynet-config';
import update_skynet_config from './skynet/config/update-skynet-config';
import test_webhook_skynet_config from './skynet/config/test-webhook-skynet-config';
import around_skynet_search from './skynet/search/around-skynet-search';
import bound_skynet_search from './skynet/search/bound-skynet-search';
import create_search_skynet_polygon from './skynet/search/polygon/create-search-skynet-polygon';
import get_search_skynet_polygon from './skynet/search/polygon/get-search-skynet-polygon';
...
import retrieve_result_optimization_v2 from './optimization/v2/retrieve-result-optimization-v2';
...
import retrieve_discover from './discover/retrieve-discover';
...
import create_distance_matrix_json from './distance-matrix/json/create-distance-matrix-json';
import retrieve_distance_matrix_json from './distance-matrix/json/retrieve-distance-matrix-json';
...
addEndpoint(list_skynet_asset);
addEndpoint(delete_skynet_asset);
addEndpoint(bind_skynet_asset);
addEndpoint(track_skynet_asset);
addEndpoint(update_attributes_skynet_asset);
addEndpoint(list_asset_skynet_event);
addEndpoint(list_asset_skynet_location);
addEndpoint(get_last_asset_skynet_location);
addEndpoint(create_skynet_monitor);
addEndpoint(retrieve_skynet_monitor);
addEndpoint(update_skynet_monitor);
addEndpoint(list_skynet_monitor);
...
addEndpoint(get_summary_skynet_trip);
addEndpoint(start_skynet_trip);
addEndpoint(create_skynet_namespaced_apikeys);
addEndpoint(delete_skynet_namespaced_apikeys);
addEndpoint(retrieve_skynet_config);
addEndpoint(update_skynet_config);
addEndpoint(test_webhook_skynet_config);
addEndpoint(around_skynet_search);
addEndpoint(bound_skynet_search);
addEndpoint(create_search_skynet_polygon);
addEndpoint(get_search_skynet_polygon);
...
addEndpoint(retrieve_result_optimization_v2);
...
addEndpoint(create_distance_matrix_json);
addEndpoint(retrieve_distance_matrix_json);
