import fs from 'fs';
import type { ResponseLike } from 'nextbillion-ai/internal/to-file';
import { toFile } from 'nextbillion-ai/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('nextbillion-ai/core/uploads');
    await expect(
