...
export class Browse extends APIResource {
   ...
   */
  search(query: BrowseSearchParams, options?: RequestOptions): APIPromise<BrowseSearchResponse> {
    return this._client.get('/browse', { query, ...options });
  }
}
...
export interface BrowseSearchResponse {
   ...
   */
  items?: Array<BrowseSearchResponse.Item>;
}

export namespace BrowseSearchResponse {
...
export declare namespace Browse {
  export { type BrowseSearchResponse as BrowseSearchResponse, type BrowseSearchParams as BrowseSearchParams };
}
