...
export class Autocomplete extends APIResource {
   ...
   */
  suggest(
    query: AutocompleteSuggestParams,
    options?: RequestOptions,
  ): APIPromise<AutocompleteSuggestResponse> {
    return this._client.get('/autocomplete', { query, ...options });
  }
}

export interface AutocompleteSuggestResponse {
  /**
   ...
   */
  items?: Array<AutocompleteSuggestResponse.Item>;
}

export namespace AutocompleteSuggestResponse {
...
export interface AutocompleteSuggestParams {
  /**
