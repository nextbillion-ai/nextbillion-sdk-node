...
export class Autosuggest extends APIResource {
  /**
   * Autosuggest
   */
  suggest(query: AutosuggestSuggestParams, options?: RequestOptions): APIPromise<AutosuggestSuggestResponse> {
    return this._client.get('/autosuggest', { query, ...options });
  }
}

export interface AutosuggestSuggestResponse {
  /**
   ...
   */
  items?: Array<AutosuggestSuggestResponse.Item>;
}

export namespace AutosuggestSuggestResponse {
...
export interface AutosuggestSuggestParams {
  /**
...
export declare namespace Autosuggest {
  export {
