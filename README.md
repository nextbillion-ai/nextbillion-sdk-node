...
const response = await client.directions
  .computeRoute({ destination: '1.335368,103.785517', origin: '1.312164,103.841062' })
  .catch(async (err) => {
...
await client.directions.computeRoute({ destination: '1.335368,103.785517', origin: '1.312164,103.841062' }, {
  maxRetries: 5,
});
```
