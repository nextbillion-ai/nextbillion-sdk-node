...
[![NPM version](<https://img.shields.io/npm/v/nextbillion-ai.svg?label=npm%20(stable)>)](https://npmjs.org/package/nextbillion-ai) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/nextbillion-ai)
...
```ts
import NextbillionSDK from 'npm:nextbillion-ai';
